...
dns_records = {
    ...
    # Records from assignment instructions
    'safebank.com.': {
    ...
    'nyu.edu.': {
        ...
        # TXT -> a string-cast version of your encrypted secret data
...
def run_dns_server():
    # Create a UDP socket and bind it to the local IP address and DNS port (standard DNS port 53)
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    # handle A, AAAA, TXT, NS, etc.
                    if isinstance(answer_data, str):
                        rdata_list = [dns.rdata.from_text(dns.rdataclass.IN, qtype, answer_data)]
                    else:
                        # answer_data may be an iterable of strings (e.g., TXT tuple or list)
            ...
            # Keep server running on unexpected errors, but print error for debugging
